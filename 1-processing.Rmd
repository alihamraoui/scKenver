...
```{r Save}
output_dir <- file.path(paste0("./output/data/", data_name))
...
saveRDS(Qc.per.cell, file = paste0(output_dir,"/QC.per.cell.Rdata"))
saveRDS(total_UMI, file =   paste0(output_dir,"/total_UMI.Rdata"))
```
