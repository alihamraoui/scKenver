...
print(benchmark_dir)
print(paste0(benchmark_dir,"/bin/corr-analysis.R"))
load(file = paste0(benchmark_dir,  "/input/data/illumina_data.Rdata"))
load(file = paste0(benchmark_dir, "/input/data/", data_name, "_data.Rdata"))
...
```{r Save}
output_dir <- file.path(paste0(benchmark_dir,"/output/"))
print(output_dir)
